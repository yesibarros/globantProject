...
const useBackgroundNotifications = () => {
  ...
  return (Notifications, navigation) =>
        ...
        if (user == loginUser._id) {
          ...
          switch (type) {
            ...
            case "newRequest":
              ...
              dispatch(
                setReceivedPendingRequests(receivedPendingRequests)
              ).then(() => navigation.navigate("Notificaciones"));
              break;
            case "cancelMatch":
              ...
              break;
            case "goals":
              dispatch(getObjectives(user)).then(() =>
                navigation.navigate("Notificaciones")
              );
              break;
            case "meeting":
