...
import { View, Text, Button, TextInput, TouchableWithoutFeedback, ActivityIndicator } from 'react-native'
import { StyleSheet } from "react-native";
import {primaryGreen} from "../../../utils/Colors"
import { BlurView } from 'expo-blur';
import { useTheme } from "@react-navigation/native";

const TextEndOfMentoring = ({setModalTextEnd, handleSendEndOfMentoring, isLoading, closeMenu}) => {
                ...
                <View style={[styles.surface, {backgroundColor: colors.background}]}>
                    ...
                    <View style={styles.buttonsContainer}>
                        <View style={styles.button}>
                            <Button title="cancelar" color="gray" onPress={()=>setModalMeeting(false)}/>
                        </View>
                        <View style={styles.button}>
                            {!isLoading? (<Button title="enviar" color={primaryGreen} onPress={()=> {
                                sendEndOfMentoring()
                            }}/>) : (
